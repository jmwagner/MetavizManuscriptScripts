...
genusOfInterest <- c("Actinomyces", "Rothia", "Neisseria", "Citrobacter", "Dickeya", "Enterobacter", "Escherichia", "Klebsiella", "Shigella", "Haemophilus", 
                     "Acinetobacter", "Bifidobacterium", "Bacteroides", "Prevotella")

logFC_mali[genusOfInterest,]