...
orderOfInterest <- c("Actinomycetales", "Enterobacteriales", "Lactobacillales", "Pasteurellales", "Pseudomonadales", "Coriobacteriales", "Bacteroidales", "Clostridiales")

logFC_bangladesh[orderOfInterest,]