...
genusOfInterest <- c("Megasphaera", "Veillonella", "Campylobacter", "Citrobacter", "Enterobacter", "Escherichia", "Klebsiella", "Shigella", "Haemophilus", "Prevotella")

logFC_kenya[genusOfInterest,]