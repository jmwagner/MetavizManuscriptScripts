...
genusOfInterest <- c("Rothia", "Escherichia", "Shigella",  "Granulicatella", "Streptococcus", "Haemophilus", "Acinetobacter", "Collinsella", "Bacteroides", "Clostridium", "Eubacterium", "Dorea", "Faecalibacterium", "Ruminococcus")

logFC_bangladesh[genusOfInterest,]
