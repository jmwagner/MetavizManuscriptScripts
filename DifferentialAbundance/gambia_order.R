...
orderOfInterest <- c("Actinomycetales", "Lactobacillales", "Campylobacterales", "Enterobacteriales", "Pasteurellales", "Pseudomonadales", "Bacteroidales", "Clostridiales")

logFC_gambia[orderOfInterest,]